...
def test_get_level_name_from_num(theme, input_level, expected_enum):
    ...
    :return:
    """
    result = Levels.get_level_name_from_num(theme, input_level)
...
def test_level_smashcore_1(mock_scale_image, mock_image_load, mock_gameworld):
    ...
    """
    assets.load_assets()
    Levels.build_level(mock_gameworld.world_objects, Levels.LevelName.CLASSIC_RANDOM_1)
...
@pytest.mark.parametrize("level_name", [
    Levels.LevelName.CLASSIC_SOLID_ROWS_1,
    Levels.LevelName.MODERN_SOLID_ROWS_1,
    Levels.LevelName.CLASSIC_SOLID_ROWS_SPACERS_1,
    Levels.LevelName.MODERN_MULTIPLIER_1,
    Levels.LevelName.MODERN_UNBREAKABLE_1,
])
