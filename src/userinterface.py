...
class UserInterface:
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if hasattr(self, 'how_to_play_button_rect') and self.how_to_play_button_rect.collidepoint(mouse_pos):
                return GameState.GameStateName.HOW_TO_PLAY
            elif hasattr(self, 'how_to_play_back_button_rect') and self.how_to_play_back_button_rect.collidepoint(mouse_pos):
                return GameState.GameStateName.MENU_SCREEN
            elif hasattr(self, 'credits_button_rect') and self.credits_button_rect.collidepoint(mouse_pos):
                return GameState.GameStateName.CREDITS
        return None
