                ...
                for event in events:
                    if event.type == pygame.MOUSEBUTTONDOWN:
                        ...
                        if self.ui.vol_bgm_btn_rect.collidepoint(event.pos):
                            ...
                            print("flips bgm_sounds")
                            print(abs(self.gset.music_volume))
                            print(abs(self.gset.music_volume) < CLOSE_TO_ZERO)
                            print("not self.gset.bgm_sounds = ", not self.gset.bgm_sounds)
                            if not self.gset.bgm_sounds and abs(self.gset.music_volume) < CLOSE_TO_ZERO:
                                self.gset.bgm_sounds = True
                                print("before ", self.gset.music_volume)
                                self.gset.music_volume = MUSIC_VOLUME_STEP
                                print("after", self.gset.music_volume)
                                pygame.mixer.music.set_volume(self.gset.music_volume)
                        ##########################
                        # Mute/Unmute sound effects music
                        ##########################
