...
BRICK_SFX_CHANNEL, TOP_WALL_SFX_CHANNEL, PADDLE_SFX_CHANNEL = None, None, None
LEFT_WALL_SFX_CHANNEL, RIGHT_WALL_SFX_CHANNEL = None, None
...
def load_assets():
    ...
    global MUTE_ICON, VOLUME_ICON, CHANNEL, BRICK_SFX_CHANNEL, TOP_WALL_SFX_CHANNEL, PADDLE_SFX_CHANNEL
    global LEFT_WALL_SFX_CHANNEL, RIGHT_WALL_SFX_CHANNEL
    ...
    # soundfx
    BRICK_SFX = pygame.mixer.Sound(asset_path(SOUND_DIR, BRICK_SFX_FILENAME))
    PADDLE_SFX = pygame.mixer.Sound(asset_path(SOUND_DIR, PADDLE_SFX_FILENAME))
    LEFT_WALL_SFX = pygame.mixer.Sound(asset_path(SOUND_DIR, LEFT_WALL_SFX_FILENAME))
    RIGHT_WALL_SFX = pygame.mixer.Sound(asset_path(SOUND_DIR, RIGHT_WALL_SFX_FILENAME))
    TOP_WALL_SFX = pygame.mixer.Sound(asset_path(SOUND_DIR, TOP_WALL_SFX_FILENAME))

    # sound channel selector
    CHANNEL = [pygame.mixer.Channel(i) for i in range(7)]

    # reserved channels for soundfx
    BRICK_SFX_CHANNEL = CHANNEL[0]
    PADDLE_SFX_CHANNEL = CHANNEL[1]
    LEFT_WALL_SFX_CHANNEL = CHANNEL[2]
    RIGHT_WALL_SFX_CHANNEL = CHANNEL[3]
    TOP_WALL_SFX_CHANNEL = CHANNEL[4]
